package com.medcognize.view.transactions;
...
public final class TransactionsView extends VerticalLayout implements View {
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(MedcognizeUI
        ...
        table.setColumnFooter(
                "price",
                "$"
                        + DECIMALFORMAT.format(MedcognizeUI.getDataProvider()
                                .getTotalSum()));
    ...
    @Subscribe
    public void browserResized(final MedcognizeEvent.BrowserResizeEvent event) {
            ...
            if (action == report) {
                ...
                if (item != null) {
                    Long movieId = (Long) item.getItemProperty("movieId")
                            .getValue();
                    MovieDetailsWindow.open(MedcognizeUI.getDataProvider()
