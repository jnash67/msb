package com.medcognize.view.reports;
...
public final class ReportsView extends TabSheet implements View, CloseHandler,
    ...
    public void addReport(final ReportType reportType, final Object prefillData) {
        ...
        MedcognizeEventBus.post(new MedcognizeEvent.ReportsCountUpdatedEvent(
                getComponentCount() - 1));
        setSelectedTab(getComponentCount() - 1);
    }

    @Subscribe
    public void createTransactionReport(final MedcognizeEvent.TransactionReportEvent event) {
