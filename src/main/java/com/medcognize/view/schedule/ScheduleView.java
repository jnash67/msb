package com.medcognize.view.schedule;

import com.google.common.eventbus.Subscribe;
import com.medcognize.MedcognizeUI;
import com.medcognize.component.MovieDetailsWindow;
...
@SpringView(name = ScheduleView.NAME)
public final class ScheduleView extends CssLayout implements View {
    ...
    private Component buildCatalogView() {
        ...
        for (final Movie movie : MedcognizeUI.getDataProvider().getMovies()) {
    ...
    @Subscribe
    public void browserWindowResized(final MedcognizeEvent.BrowserResizeEvent event) {
    ...
    private class MovieEventProvider implements CalendarEventProvider {
        ...
        public List<CalendarEvent> getEvents(final Date startDate,
            ...
            // when needed.
            Collection<Transaction> transactions = MedcognizeUI
                    .getDataProvider().getTransactionsBetween(startDate,
                            endDate);
            List<CalendarEvent> result = new ArrayList<CalendarEvent>();
            for (Transaction transaction : transactions) {
                Movie movie = MedcognizeUI.getDataProvider().getMovie(
