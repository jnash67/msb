    ...
    public void uploadSucceeded(Upload.SucceededEvent event) {
        try {
            ...
            FileHeader medicalExpensesZipEntry = ZipUtil.getZipEntryFileHeader(zf,
                    MedcognizeExportFileFormat.medicalExpensesZipEntryFileName);
            ...
            List<User> users = CsvUtil.csvWithHeaderToDisplayFriendlyList(User.class, ZipUtil.getCsvEntryFromZip(zf,
                    userZipEntry), null);
            if (null == users) {
