...
public class Provider extends DisplayFriendlyAbstractEntity implements Serializable {
	...
	private static final String captionString = "providerName:Name, providerInPlan:In Plan, " +
		"providerType:Provider Type, " +
		"providerId:Provider Id, " +
		"address1:Address 1, address2:Address 2, city:City, state:State, zip:Zip, " +
		"phoneNumber:Phone Number, website:Website";

	public static enum ProviderType {PRIMARY, SPECIALIST, PHARMACY, HOSPITAL, OTHER}

	public static final ProviderType defaultProviderType = ProviderType.PRIMARY;

	private static final String providerTypeCaptionString = ProviderType.PRIMARY.toString() + ":Primary Care Doctor," +
		" " +
		"" + ProviderType.SPECIALIST.toString() + ":Specialist," +
		ProviderType.PHARMACY.toString() + ":Pharmacy, " +
		"" + ProviderType.HOSPITAL.toString() + ":Hospital," +
		ProviderType.OTHER.toString() + ":Other";
